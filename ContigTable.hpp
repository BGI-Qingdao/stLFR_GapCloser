...
class ContigTable
{
            ...
            mismatchLen(_mismatchLen)
    {
        ...
        void initialize() {
            ...
            std::cout << ">>>>>>>>>>scaffold initializing<<<<<<<<<<" << std::endl;
            std::cout << std::endl;
            time_t total_start_time=time(NULL);



            std::cout << "counting scaffolds" << std::endl;
            time_t start_time=time(NULL);

            countContigs(fin);

            std::cout << "scaffolds sum: " << contigsSum <<std::endl;
            std::cout << "spent time: " << time(NULL)-start_time << "s" << std::endl;
            std::cout << "scaffolds counted" << std::endl;
            std::cout << std::endl;
            ...
            std::cout << "initializing scaffolds" << std::endl;
            start_time=time(NULL);

            initializeContigs(fin);

            std::cout << "spent time: " << time(NULL)-start_time << "s" << std::endl;
            std::cout << "scaffolds initialized" << std::endl;
            std::cout << std::endl;



            std::cout << "scaffold sum " << contigsSum <<std::endl;
            std::cout << "spent total time: " << time(NULL)-total_start_time << "s" <<std::endl;
            std::cout << ">>>>>>>>>>scaffold initialization finished<<<<<<<<<<" << std::endl;
            std::cout << std::endl;
        }

        void countContigs(std::ifstream& fin) {
        ...
        void initializeContig(Len_t iContig, std::string const& strSeq) {

            Len_t contigLength = strSeq.length();

            Len_t i=0;
            //ignore 'N' std::string at head
